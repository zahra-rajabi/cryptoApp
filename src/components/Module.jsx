...
function Module({ setOpenModal, modalData, night }) {
  ...
  return (
    ...
    >
      <section
        className={`w-full md:w-3/5 mx-4 md:mx-0 p-2 md:p-4 text-indigo-100 border rounded-lg shadow-md h-3/5 xl:h-4/6 xl:w-3/6 border-indigo-50/50 bg-zinc-900/70 ${
